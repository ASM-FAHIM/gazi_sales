...
class Production_BarChart extends StatelessWidget {
  Future<List<MonthData>> fetchDataFromApi() async {
    final response = await http.get(Uri.parse('http://${AppConstants.baseurl}/GAZI/management_dashboard/production_barchart.php'));
