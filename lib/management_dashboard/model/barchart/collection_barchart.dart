...
//       double maxValue = monthDataList.map((data) => data.achivement).reduce((a, b) => a > b ? a : b);
//
//       // Update the values to be percentage of the maximum value
//       for (var data in monthDataList) {
//         data.valuePercentage = (data.achivement / maxValue) * 100;
//       }
//
...
//                 } else {
//                   // Initialize previousMonth variable outside the List.generate method
...
//
//                         // Check if the current month differs from the previous one
//                         final currentMonth = monthData.month;
//                         final displayMonth = currentMonth != previousMonth ? currentMonth : '';
...
//                             // ),
//                             DataCell(
//                               buildBarChart(monthData.valuePercentage, monthData.achivement),
//                             ),
//                           ],
//                         );
//                       }),
...
//
//             // Text(
//             //   'Achievement: $formattedValueAchievement',
//             //   style: TextStyle(
//             //     color: Colors.black,
//             //     fontWeight: FontWeight.bold,
//             //   ),
...
//
//
// // Widget buildBarChart(double target, double achivement) {
//   //   final formattedValue_achivement = NumberFormat('#,##,###').format(achivement);
//   //   final formattedValue_target = NumberFormat('#,##,###').format(target);
//   //
//   //   return Container(
//   //     width: 150,
//   //     child: Column(
...
//     final double achivement = double.parse(json['achivement']);
//     return MonthData(
//       month: month,
//       target: target,
...
// //   factory MonthData.fromJson(Map<String, dynamic> json) {
// //     final String month = json['xmonthname'];
// //     final String business = json['target'];
// //     final double value = double.parse(json['achivement']);
// //     return MonthData(
// //       month: month,
// //       business: business,
// //       value: value,
