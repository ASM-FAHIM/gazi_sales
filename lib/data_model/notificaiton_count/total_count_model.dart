...
class TotalAdminCount {
  ...
  int salesCount;
  int scmCount;
  int personal_HR_Count;
  int Employee_HR_Count;
  ...
  TotalAdminCount({
    ...
    required this.personal_HR_Count,
    required this.Employee_HR_Count,
  ...
  factory TotalAdminCount.fromJson(Map<String, dynamic> json) =>
      TotalAdminCount(
        ...
        personal_HR_Count: json["personal_HR_Count"],
        Employee_HR_Count: json["Employee_HR_Count"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "SCM_Count": scmCount,
        "personal_HR_Count": personal_HR_Count,
        "Employee_HR_Count": Employee_HR_Count,
...
class ProductionModel {
  ...
  int assembleBatchCount;

  ProductionModel({
    required this.bomCount,
    required this.batchCount,
    required this.insCount,
    required this.customBatchCount,
    required this.assembleBatchCount,
  });

  factory ProductionModel.fromJson(Map<String, dynamic> json) =>
      ProductionModel(
        bomCount: json["BOMCount"] ?? 0,
        batchCount: json["BatchCount"] ?? 0,
        insCount: json["InsCount"] ?? 0,
        customBatchCount: json["CustomBatchCount"] ?? 0,
        assembleBatchCount: json["AssembleBatchCount"] ?? 0,
      );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "InsCount": insCount,
    "CustomBatchCount": customBatchCount,
    "AssembleBatchCount": assembleBatchCount,
  };
}
...
class SalesMOdel {
  ...
  factory SalesMOdel.fromJson(Map<String, dynamic> json) => SalesMOdel(
    ...
    cusCount: json["CUS_Count"],
    excCount: json["EXC_Count"],
  );
