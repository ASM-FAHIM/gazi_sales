...
// To parse this JSON data, do
//
//     final clEmpSlModel = clEmpSlModelFromJson(jsonString);



ClEmpSlModel clEmpSlModelFromJson(String str) => ClEmpSlModel.fromJson(json.decode(str));

String clEmpSlModelToJson(ClEmpSlModel data) => json.encode(data.toJson());
...
class ClEmpSlModel {
  ...
  ClEmpSlModel({
    required this.clRcount,
    required this.empReqCount,
    required this.slCount,
  });

  factory ClEmpSlModel.fromJson(Map<String, dynamic> json) => ClEmpSlModel(
    clRcount: json["CLRcount"],
    empReqCount: json["empReqCount"],
    slCount: json["SLCount"],
  );

  Map<String, dynamic> toJson() => {
    "CLRcount": clRcount,
    "empReqCount": empReqCount,
    "SLCount": slCount,
  };
}
