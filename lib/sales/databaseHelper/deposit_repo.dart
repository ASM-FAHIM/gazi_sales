...
class DepositRepo {
  ...
  Future<int> insertIntoBankTable(dynamic bankData) async {
    ...
    try {
      ...
      print('There are some issues inserting into bank table insertIntoBankTable : $e');
    }
  ...
  Future<List> getFromBankTable(String zid) async {
    ...
    try {
      ...
      print("There are some issues getting products getFromBankTable : $e");
    }
    return bankList;
  }
  ...
  Future<int> insertIntoPaymentTable(dynamic payment) async {
    ...
    try {
      ...
      print('There are some issues inserting into payment table insertIntoPaymentTable : $e');
    }
    return result;
  }
  ...
  Future<List> getInvoiceTable(String zid) async {
    ...
    try {
      ...
      print("There are some issues getting products getInvoiceTable : $e");
    }
    return paymentList;
  }
  ...
  Future<List> getFromPaymentTable(String zid) async {
    ...
    try {
      ...
      print("There are some issues getting products getFromPaymentTable : $e");
    }
    return paymentList;
  }
  ...
  Future<int> depositInsert(Map<String, dynamic> data) async {
    ...
    try {
      ...
      print('There are some issues inserting DepositTable depositInsert : $e');
    }
    return result;
  }
  ...
  Future<int> getDepositID() async {
    ...
    try {
      ...
      print("There are some issues getDepositID : $e");
    }
  ...
  Future<List> getOpenDeposit(String zID) async {
    ...
    try {
      ...
      print("There are some issues getOpenDeposit : $e");
    }
    return openDeposit;
  }
