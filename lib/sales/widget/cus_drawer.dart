...
import 'package:gazi_sales_app/data_model/loginModel.dart';
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Get.back();
                          Get.to(() => DashboardScreen(business_name: 'My Gazi',zid: zid));
                        },
                        leading: const Icon(
                      ...
                      ListTile(
                        onTap: () {
                          Get.back();
                          Get.to(() => DepositEntryScreen(zbusiness: zbusiness, zid: zid,));
                        },
                        leading: const Icon(
                          MdiIcons.bank,
                          color: AppColor.appBarColor,
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Get.back();
                          Get.to(() => OrderScreen(zid: zid, zbusiness: zbusiness,));
                        },
                        leading: const Icon(
                      ...
                      ListTile(
                        onTap: () {
                          Get.back();
                          Get.to(() => DealerReportScreen(zid: zid, xposition: loginController.xposition.toString(),));
                        },
                        leading: const Icon(
                          MdiIcons.chartLine,
                          color: AppColor.appBarColor,
                      ...
                      ListTile(
                        onTap: () {
                          Get.back();
                          Get.to(() => NotificationScreen(zid: zid, zbusiness: zbusiness,));
                        },
                        leading: const Icon(
                      ...
                      ListTile(
                        onTap: () {
                          // Get.offAll(() => Confirm_password(xposition: loginModel.xposition, xoldpass: loginModel.xpassword,));
                        },
                        leading: const Icon(
                          MdiIcons.logout,
                          color: AppColor.appBarColor,
