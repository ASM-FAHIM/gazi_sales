                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  BigText(
                                    text:
                                        'Total = ${cartController.totalAmount.toStringAsFixed(2)} Tk.',
                                    size: 18,
                                    color: Colors.red,
                                  ),
                                ],
...
class ReusableAlert extends StatelessWidget {
  ...
  final String zid;
  final String tsoId;
  TextEditingController xdeliloc = TextEditingController();
      ...
      actions: <Widget>[
        ...
        TextButton(
          ...
          onPressed: () async {
            ...
            await cartController.confirmOrder(zid, soNum, tsoId, xdeliloc.text);
          },
        ),
      ],
    );
