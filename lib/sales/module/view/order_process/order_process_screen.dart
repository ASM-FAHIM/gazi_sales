...
class OrderScreen extends StatefulWidget {
  OrderScreen({required this.zid, required this.zbusiness});
  String zbusiness;
  String zid;
                                      ...
                                      child: Container(
                                        ...
                                        child: TextButton(
                                          onPressed: () {
                                            ...
                                            //print("widget.zid"+widget.zid);

                                            if(widget.zid == '400060' || widget.zid == '400070'){
                                              ...
                                              Get.to(
                                                    ...
                                                    delDisc: dashboardController
                                                        .foundDealerList[
                                                    index]['xdisc'], zbusiness: widget.zbusiness,
                                                  ));
                                            }
