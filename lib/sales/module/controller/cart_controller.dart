...
class CartController extends GetxController {
  ...
  void resetCartController() {
    totalClick.value = 0;
    totalPrice.value = 0.0;
    totalPackQty.value = 0.0;
    addedProducts.clear();
  }

  // Function to initialize the CartController if it hasn't been initialized
  ...
  // Method to clear added products and reset total click value
  void clearCart() {
    addedProducts.clear();
    totalClicked();
    print('Reset total click: $addedProducts');// Reset total click value
  }
  ...
  Future<void> addToCart(
    ...
    try {
      // Check if the CartController instance exists
      ...
      totalClicked();
      update();
      // After adding products, update the state to trigger rebuild
  ...
  void totalClicked() {
    try {
      ...
      print('There is an error totalClicked : $e');
    }
  }
  /*void totalClicked() {
    try {
  ...
  void runFilterForAccessories(String keyword) async {
    try {
      ...
      isSearched(false);
      print('Error Occured runFilterForAccessories : $e');
    }
  }
...
// method for accessories update from cart screeen
  ...
  Future<void> updateFromCartScreenAcc(String productCode, int qty) async {
    try {
      ...
      isCartAccLoaded(false);
      print('There are some issue updateFromCartScreenAcc : $error');
    }
  }
  ...
  void updateAdditionalPriceAndDiscount(int itemIndex, String discount, String itemPrice, String xnote) {
    addedProducts[itemIndex][5] = discount;
    addedProducts[itemIndex][3] = itemPrice;
    addedProducts[itemIndex][11] = xnote;
  }
  ...
  Future<void> insertToCart(String cusId, String xOrg, String status) async {
    // try {
      ...
      for (int i = 0; i < addedProducts.length; i++) {
        ...
        String xnote = addedProducts[i][11];
...
/*      Get.snackbar('Successful', 'Order added successfully',
    ...
    // catch (error) {
    //   saving(false);
    //   print('There are some issue insertToCart : $error');
    // }
  }
  ...
  Future<void> getCartHeaderDetailsList(String cartId) async {
    try {
      ...
      print('There are some issue getCartHeaderDetailsList: $error');
    }
  }
  ...
  Future<void> getCarHisAccList(String cartId, String productId) async {
    try {
      ...
      print('There are some issue getCarHisAccList : $error');
    }
  }
  ...
  Future<void> getCartHeaderDetailsListForSync(String cartId) async {
    try {
      ...
      print('There are some issue getCartHeaderDetailsListForSync : $error');
    }
  }
  ...
  Future<void> allCartHeaderDetails(String cartId) async {
    try {
      ...
      print('There are some issue allCartHeaderDetails : $error');
    }
  }
  ...
  Future<void> uploadCartOrder() async {
    try {
      ...
      print('There are some issue uploadCartOrder : $error');
    }
  }
  ...
  Future<void> placeOrder(
    ...
    try {
          ...
          case InternetConnectionStatus.connected:
            ...
            for (int j = 0; j < listCartHeaderDetailsForSync.length; j++) {
              var dataDetails = jsonEncode(<String, dynamic>{
                ...
                "xnote": listCartHeaderDetailsForSync[j]['xnote']
              });
              var responseDetails = await http.post(
                  Uri.parse(
                      'http://${AppConstants.baseurl}/gazi/salesforce/SOdetailsTableInsert.php'),
                  body: dataDetails);
              print("2${responseDetails.body}");
              if (responseDetails.statusCode == 200) {
                await DatabaseRepo()
      ...
      print('Error occured placeOrder :$e');
    }
  }
          ...
          case InternetConnectionStatus.connected:
            ...
            for (int j = 0; j < idWiseCartHeaderDetails.length; j++) {
              var dataDetails = jsonEncode(<String, dynamic>{
                ...
                'xnote': idWiseCartHeaderDetails[j]['xnote'],
              });
              var responseDetails = await http.post(
                  Uri.parse(
                      'http://${AppConstants.baseurl}/gazi/salesforce/SOdetailsTableInsert.php'),
                  body: dataDetails);
              print("3${responseDetails.body}");
  ...
  Future<void> updateItemWiseCartDetails(
    ...
    try {
      ...
      print('Failed to execute the process updateItemWiseCartDetails: $e');
    }
  }
  ...
  Future<void> updateFromAccHisScreen(String accCode, String cartID, String qty,
    ...
    try {
      ...
      print('Failed to execute the process updateFromAccHisScreen : $e');
    }
  }

  ///discount portion
  TextEditingController discount = TextEditingController();
  TextEditingController newProductPrice = TextEditingController();
...
//normally database theke anar jonno
  ...
  Future getAddedProducts(String zId, String soNum) async {
    try {
      ...
      if (responseProcess.statusCode == 200) {
        ...
        totalDiscount = listOfAddedProducts.fold(
            0.0, (sum, product) => sum + double.parse(product.xdisc));
      } else {
      }
    } catch (e) {
      print('Exception getAddedProducts : $e');
    } finally {
      isValueLoaded(false);
    }
  }
  ...
  Future<void> fetchDropdownItems(String xcus) async {
    try {
      ...
      print('Please check again fetchDropdownItems : $e');
    } finally {
      isProcessing(false);
    }
  }
  ...
  Future<void> processOrder(
    ...
    try {
        ...
        switch (status) {
          case InternetConnectionStatus.connected:
            ...
            for (int j = 0; j < listCartHeaderDetailsForSync.length; j++) {
              ...
              print('dataDetails[$j]: $dataDetails'); // Print the dataDetails
              var responseDetails = await http.post(
                  Uri.parse(
                      'http://${AppConstants.baseurl}/gazi/salesforce/SOdetailsTableInsert.php'),
                  body: dataDetails);
              print("4${responseDetails.body}");
              if (responseDetails.statusCode == 200) {
                await DatabaseRepo()
                    .updateCartHeaderTable(tempHeader, incentive.value);
              }
      ...
      print('Error occured processOrder : $e');
    }
  }

  RxBool isConfirmed = false.obs;

  Future<void> confirmOrder(String zid, String soNum, String tsoId, String xdeliloc) async {
    try {
      isConfirmed(true);
      ...
      print('Please check again confirmOrder : $e');
    } finally {
      isConfirmed(false);
    }
  }
