...
class LoginController extends GetxController {
  ...
  Future<void> getBusinessList() async {
    try {
      ...
      isDone(false);
      print('There are some issue getBusinessList : $error');
    }
  }
  ...
  Future getTsoInfo(String xTso, String xTerritory, String zone, String zm,
      String division, String dm, String business_name, String zid) async {
    try {
      xtso.value = xTso;
    ...
    Get.to(() => DashboardScreen(business_name: business_name, zid: zid,));
  }
  ...
  Future<Object> fetchTerritoryList() async {
    try {
      ...
      print(responseTerritoryList.body);
