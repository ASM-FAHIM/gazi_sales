...
class LoginController extends GetxController {
  ...
  Future<void> insertBusinessTable(String zemail) async{
    try{
      isDataLoaded(true);
      var response = await http.get(Uri.parse('http://${AppConstants.baseurl}/gazi/zid.php?zemail=$zemail'));
        ...
        (json.decode(response.body) as List).map((businessInfo) {
          LoginRepo().insertToBusinessTable(UserWiseBusinessModel.fromJson(businessInfo));
        }).toList();
