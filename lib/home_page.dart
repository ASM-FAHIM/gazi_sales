...
import 'package:gazi_sales_app/screen/change_password.dart';
...
class Homepage extends StatefulWidget {
  ...
  Homepage({required this.isConnected, required this.zemail, required this.loginModel});
                  ...
                  child: IconButton(
                    onPressed: () async {
                      Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => Confirm_password_user(xposition: xposition, xoldpass: xpassword, loginModel: widget.loginModel,)));
                    },
                    icon: const Icon(
                      Icons.lock,
                      color: Color(0xff074974),
                ...
                : SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        if(widget.loginModel.xrole == 'Management')...[
                          Padding(
                        ...
                        if(widget.zemail == 'demo4apps')...[

                        ]else if(widget.loginModel.zactiveopapp == '1')...[
                          Padding(
                            padding: EdgeInsets.only(
                                top: 10, left: 30, right: 30, bottom: 10),
                            child: Container(
