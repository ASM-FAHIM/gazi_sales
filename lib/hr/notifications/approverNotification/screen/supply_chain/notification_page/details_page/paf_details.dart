...
class PAF_details_notification extends StatefulWidget {
  ...
  @override
  State<PAF_details_notification> createState() =>
      _PAF_details_notificationState();
}

class _PAF_details_notificationState extends State<PAF_details_notification> {
  String api = API_Names().api;
  Future<List<PafDetailsModel>>? futurePost;
  String rejectNote = " ";

  Future<List<PafDetailsModel>> fetchPostdetails() async {
    var response = await http.post(
        Uri.parse('http://$api/ughcm/UG/purchase/PAF_Detail.php'),
        body: jsonEncode(<String, String>{
          "zid": widget.zid,
          "xpafnum": widget.xpafnum,
        }));
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<PafDetailsModel>((json) => PafDetailsModel.fromJson(json))
          .toList();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<PafDetailsModel>>(
          future: futurePost,
                    ...
                    children: [
                      TextButton(
                        ...
                        onPressed: is_pressed_approved_reject ? null :  () async {
                          ...
                          var response = await http.post(
                              Uri.parse(
                                  'http://$api/ughcm/UG/purchase/PAF_Approve.php'),
                              body: jsonEncode(<String, String>{
                                "zid": widget.zid,
                                "user": widget.zemail,
                                  ...
                                  actions: [
                                    TextButton(
                                      ...
                                      onPressed: is_pressed_approved_reject ? null :  () async {
                                        ...
                                        var response = await http.post(
                                            Uri.parse(
                                                'http://$api/ughcm/UG/purchase/PAF_Reject.php'),
                                            body: jsonEncode(<String, String>{
                                              "zid": widget.zid,
                                              "user": widget.zemail,
                                              "xposition": widget.xposition,
