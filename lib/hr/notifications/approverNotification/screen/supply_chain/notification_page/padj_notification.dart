                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('Plant/Store', '${snapshot.data![index].xfwh}, ${snapshot.data![index].storeName}'),
                            _commonExpansionTileWidget('PR NO', ' ${snapshot.data![index].xadvnum}'),
                            _commonExpansionTileWidget('Employee', '${snapshot.data![index].xstaff}, ${snapshot.data![index].sname}'),
                            _commonExpansionTileWidget('SR/WR No', '${snapshot.data![index].tornum}'),
                            _commonExpansionTileWidget('PR Advance Amount ', '${snapshot.data![index].xprime}'),
                            _commonExpansionTileWidget('Reviewer Name', '${snapshot.data![index].reviewer1Name}, ${snapshot.data![index].reviewer1Designation}'),
                            _commonExpansionTileWidget('Approval Status', '${snapshot.data![index].xstatus}'),
                            const Divider(
                              thickness: 0.5,
                              color: Colors.grey,
                            ),
