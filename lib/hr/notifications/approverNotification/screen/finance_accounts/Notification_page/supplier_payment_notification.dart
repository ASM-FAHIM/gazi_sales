                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                "Exchange Rate in (Base): " +
                                    "${snapshot.data![index].xexch}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "PO No: " + "${snapshot.data![index].xpornum}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Ledger Balance: " +
                                    "${snapshot.data![index].xcusledbal} - ${snapshot.data![index].xtypetrn}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              if (double.parse(
                                ...
                                Text(
                                  "PO Balance: " +
                                      "${snapshot.data![index].xpobalance} - CR",
                                  style: GoogleFonts.bakbakOne(
                                    fontSize: 18,
                                    //color: Color(0xff074974),
                                  ),
                                ...
                                Text(
                                  "PO Balance: " +
                                      "${snapshot.data![index].xpobalance} - DR",
                                  style: GoogleFonts.bakbakOne(
                                    fontSize: 18,
                                    //color: Color(0xff074974),
                                  ),
