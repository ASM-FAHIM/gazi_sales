                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('Bank', '${snapshot.data![index].xbank}, ${snapshot.data![index].xbankname}'),
                            _commonExpansionTileWidget('Payment Mode', '${snapshot.data![index].xtypeobj}'),
                            _commonExpansionTileWidget('Received Amount', '${snapshot.data![index].xprime}'),
                            _commonExpansionTileWidget('VAT', '${snapshot.data![index].xvatamt}'),
                            _commonExpansionTileWidget('AIT', '${snapshot.data![index].xaitamt}'),
                            _commonExpansionTileWidget('Reference Date', '${snapshot.data![index].xdateref}'),
                            _commonExpansionTileWidget('MR Status', '${snapshot.data![index].xstatusmrdesc}'),
                            const Divider(
                              thickness: 0.5,
                              color: Colors.grey,
                            ),
