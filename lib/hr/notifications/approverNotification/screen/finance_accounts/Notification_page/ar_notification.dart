...
class ARNotificationScreen extends StatefulWidget {
  ...
  @override
  State<ARNotificationScreen> createState() => _ARNotificationScreenState();
}

class _ARNotificationScreenState extends State<ARNotificationScreen> {
  Future<List<ArAdminModel>>? futurePost;
  dynamic rejectNote = " ";

  Future<List<ArAdminModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse(
            'http://${AppConstants.baseurl}/gazi/notification/accounts/ar/ar.php'),
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<ArAdminModel>((json) => ArAdminModel.fromJson(json))
          .toList();
    } else {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: FutureBuilder<List<ArAdminModel>>(
                future: futurePost,
                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('Customer', '${snapshot.data![index].xcus}, ${snapshot.data![index].xcusdesc}'),
                            _commonExpansionTileWidget('Customer Type', snapshot.data![index].xarnature),
                            _commonExpansionTileWidget('Adjustment Type', snapshot.data![index].xtypeobj),
                            _commonExpansionTileWidget('Office/Depot', '${snapshot.data![index].xwh}, ${snapshot.data![index].xwhdesc}'),
                            _commonExpansionTileWidget('Account', '${snapshot.data![index].xbank}, ${snapshot.data![index].xbankname}'),
                            _commonExpansionTileWidget('Adjustment Amount', snapshot.data![index].xprime),
                            _commonExpansionTileWidget('AR Status', snapshot.data![index].xstatusmrdesc),
                            const Divider(
                              thickness: 0.5,
                              color: Colors.grey,
                            ),
                              ...
                              children: [
                                TextButton(
                                  ...
                                  onPressed: is_pressed_approved_reject[index] ? null :  () async {
                                    ...
                                    var response = await http.post(
                                        Uri.parse(
                                            'http://${AppConstants.baseurl}/gazi/notification/accounts/ar/ar_approve.php'),
                                        body: jsonEncode(<String, String>{
                                          "zid": widget.zid,
                                          "user": widget.zemail,
                                          "xposition": widget.xposition,
                                                ...
                                                onPressed: is_pressed_approved_reject[index] ? null :  () async {
                                                  ...
                                                  if (rejectNote == " ") {
                                                    ...
                                                    var response =
                                                        await http.post(
                                                            Uri.parse(
                                                                'http://${AppConstants.baseurl}/gazi/notification/accounts/ar/ar_reject.php'),
                                                            body: jsonEncode(<
                                                                String,
                                                                String>{
                                                              "zid":
