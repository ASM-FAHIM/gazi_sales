...
//
//     final arAdminModel = arAdminModelFromJson(jsonString);

import 'dart:convert';

List<ArAdminModel> arAdminModelFromJson(String str) => List<ArAdminModel>.from(
    json.decode(str).map((x) => ArAdminModel.fromJson(x)));

String arAdminModelToJson(List<ArAdminModel> data) =>
...
class ArAdminModel {
  ...
  factory ArAdminModel.fromJson(Map<String, dynamic> json) => ArAdminModel(
