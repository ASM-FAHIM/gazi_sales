                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('DC Type', '${snapshot.data![index].xpaymenttype}'),
                            _commonExpansionTileWidget('Incentive Applicable', '${snapshot.data![index].xopincapply}'),
                            _commonExpansionTileWidget('SO Number', '${snapshot.data![index].xsonumber}'),
                            _commonExpansionTileWidget('Executive Channel', '${snapshot.data![index].executive}'),
                            _commonExpansionTileWidget('ZM', '${snapshot.data![index].zm}'),
                            _commonExpansionTileWidget('DSM', '${snapshot.data![index].dsm}'),
                            _commonExpansionTileWidget('Location', '${snapshot.data![index].zone}'),
                            _commonExpansionTileWidget('Division', '${snapshot.data![index].division}'),
                            _commonExpansionTileWidget('Exp Adjustment Amt', '${snapshot.data![index].xexpamt}'),
                            _commonExpansionTileWidget('Discount Type', '${snapshot.data![index].xdisctype}'),
                            _commonExpansionTileWidget('Voucher Number', '${snapshot.data![index].xvoucher}'),
