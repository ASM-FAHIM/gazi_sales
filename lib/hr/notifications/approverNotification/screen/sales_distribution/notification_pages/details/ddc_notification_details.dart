                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _commonItemDescWidget('Quantity Required', snapshot.data![index].xqtycom.toString()),
                              _commonItemDescWidget('Excess Qty', snapshot.data![index].xqtylead.toString()),
                              _commonItemDescWidget('Short Qty', snapshot.data![index].xqtycom.toString()),
                              _commonItemDescWidget('Rate', snapshot.data![index].xqtycrn.toString()),
