...
import 'details_page/customeBat_notification_details.dart';

class CustomBAT_notification extends StatefulWidget {
  CustomBAT_notification(
  ...
  @override
  State<CustomBAT_notification> createState() => _CustomBAT_notificationState();
}

class _CustomBAT_notificationState extends State<CustomBAT_notification> {
  ...
  Future<List<BatAdminModel>> fetchPost() async {
    var response = await http.post(
      Uri.parse(
          'http://${AppConstants.baseurl}/gazi/notification/production/CustomBatch/CustomBatch.php'),
      body: jsonEncode(
        <String, String>{
          "zid": widget.zid,
