...
import 'details_page/assembleBat_notification_details.dart';
import 'details_page/bat_notification_details.dart';

class AssembleBAT_notification extends StatefulWidget {
  AssembleBAT_notification(
  ...
  @override
  State<AssembleBAT_notification> createState() => _AssembleBAT_notificationState();
}

class _AssembleBAT_notificationState extends State<AssembleBAT_notification> {
  ...
  Future<List<BatAdminModel>> fetchPost() async {
    var response = await http.post(
      Uri.parse(
          'http://${AppConstants.baseurl}/gazi/notification/production/AssambleBatch/AssambleBatch.php'),
      body: jsonEncode(
        <String, String>{
          "zid": widget.zid,
