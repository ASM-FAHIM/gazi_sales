...
class CustomBAT_details_notification extends StatefulWidget {
  CustomBAT_details_notification({
  ...
  @override
  State<CustomBAT_details_notification> createState() =>
      _CustomBAT_details_notificationState();
}

class _CustomBAT_details_notificationState extends State<CustomBAT_details_notification> {
  ...
  Future<List<BatDetailsModel>> fetchPostdetails() async {
    var response = await http.post(
        Uri.parse(
            'http://${AppConstants.baseurl}/gazi/notification/production/CustomBatch/CustomBatch_Details.php'),
                          ...
                          children: [
                            TextButton(
                              ...
                              onPressed: is_pressed_approved_reject ? null : () async {
                                ...
                                var response = await http.post(
                                    Uri.parse(
                                        'http://${AppConstants.baseurl}/gazi/notification/production/CustomBatch/CustomBatch_Approve.php'),
                                    body: jsonEncode(<String, String>{
                                      "zid": widget.zid,
                                      "user": widget.zemail,
                                          ...
                                          TextButton(
                                            ...
                                            onPressed: is_pressed_approved_reject ? null :  () async {
                                              ...
                                              if (rejectNote == " ") {
                                                ...
                                                var response = await http.post(
                                                    Uri.parse(
                                                        'http://${AppConstants.baseurl}/gazi/notification/production/CustomBatch/CustomBatch_Reject.php'),
                                                    body: jsonEncode(<String, String>{
                                                      "zid": widget.zid,
                                                      "user": widget.zemail,
                                                      "xposition": widget.xposition,
