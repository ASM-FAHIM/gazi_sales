...
class AssembleBAT_details_notification extends StatefulWidget {
  AssembleBAT_details_notification({
  ...
  @override
  State<AssembleBAT_details_notification> createState() =>
      _AssembleBAT_details_notificationState();
}

class _AssembleBAT_details_notificationState extends State<AssembleBAT_details_notification> {
  ...
  Future<List<BatDetailsModel>> fetchPostdetails() async {
    var response = await http.post(
        Uri.parse(
            'http://${AppConstants.baseurl}/gazi/notification/production/AssambleBatch/AssambleBatch_Details.php'),
                          ...
                          children: [
                            TextButton(
                              ...
                              onPressed: is_pressed_approved_reject ? null : () async {
                                ...
                                var response = await http.post(
                                    Uri.parse(
                                        'http://${AppConstants.baseurl}/gazi/notification/production/AssambleBatch/AssambleBatch_Approve.php'),
                                    body: jsonEncode(<String, String>{
                                      "zid": widget.zid,
                                      "user": widget.zemail,
                                          ...
                                          TextButton(
                                            ...
                                            onPressed: is_pressed_approved_reject ? null :  () async {
                                              ...
                                              if (rejectNote == " ") {
                                                ...
                                                var response = await http.post(
                                                    Uri.parse(
                                                        'http://${AppConstants.baseurl}/gazi/notification/production/AssambleBatch/AssambleBatch_Reject.php'),
                                                    body: jsonEncode(<String, String>{
                                                      "zid": widget.zid,
                                                      "user": widget.zemail,
                                                      "xposition": widget.xposition,
