                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                "Raw Material Store:" +
                                    "${snapshot.data![index].xwhcompdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Machine No: " +
                                    "${snapshot.data![index].xmachinenodesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Machine Name: " +
                                    "${snapshot.data![index].xmoprcsdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Arm No: " + "${snapshot.data![index].xarmno}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Operator Name: " +
                                    "${snapshot.data![index].xrefstaffdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Shift: " +
                                    "${snapshot.data![index].xshiftdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Shift Engineer: " +
                                    "${snapshot.data![index].xshiftengr}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Shift Engineer Name: " +
                                    "${snapshot.data![index].xshiftengrdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Reject Store: " +
                                    "${snapshot.data![index].xwhwastdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Reject Item Description: " +
                                    "${snapshot.data![index].xwastitemdesc}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Production Status: " +
                                    "${snapshot.data![index].descxstatusmor}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text(
                                "Approval Status: " +
                                    "${snapshot.data![index].descxstatus}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
