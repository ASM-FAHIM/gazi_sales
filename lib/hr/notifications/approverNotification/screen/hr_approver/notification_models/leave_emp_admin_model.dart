...
List<LeaveandTourempNotiModel> leaveandTourempNotiModelFromJson(String str) =>
    List<LeaveandTourempNotiModel>.from(
        json.decode(str).map((x) => LeaveandTourempNotiModel.fromJson(x)));

String leaveandTourempNotiModelToJson(List<LeaveandTourempNotiModel> data) =>
...
class LeaveandTourempNotiModel {
  ...
  factory LeaveandTourempNotiModel.fromJson(Map<String, dynamic> json) =>
      LeaveandTourempNotiModel(
          xstaff: json["xstaff"],
          xname: json["xname"],
