...
class _SQC_notificationState extends State<SQC_notification> {
  ...
  Future<List<SqcModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse(
            'http://${AppConstants.baseurl}/gazi/notification/inventory/sqc/sqc.php'),
                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('Supplier', '${snapshot.data![index].xcus}, ${snapshot.data![index].sup}'),
                            ...
                            _commonExpansionTileWidget('Work Order No. ', '${snapshot.data![index].xpornum}'),
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            SQC_details_notification(
                                              xgrnnum: snapshot
                                                  .data![index].xgrnnum.toString(),
                                              zid: widget.zid,
                                              xposition: widget.xposition,
                                              zemail: widget.zemail,
                                              xstatusdoc: snapshot
                                                  .data![index].xstatusdoc.toString(),
                                              xstaff: widget.xstaff,
                                            )));
