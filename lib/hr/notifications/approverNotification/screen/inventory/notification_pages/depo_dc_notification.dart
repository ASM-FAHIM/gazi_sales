                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('To Store', '${snapshot.data![index].xtwh}, ${snapshot.data![index].xtwhdesc}'),
                            _commonExpansionTileWidget('TO Chalan No', '${snapshot.data![index].xtornum}'),
                            _commonExpansionTileWidget('Vehicle', '${snapshot.data![index].xvehicle}'),
                            _commonExpansionTileWidget('Driver', '${snapshot.data![index].xdrivername}, ${snapshot.data![index].xphone}'),
                            _commonExpansionTileWidget('Depo DC Status', '${snapshot.data![index].statusdoc}'),
                            const Divider(
                              thickness: 0.5,
                              color: Colors.grey,
                            ),
