...
class ASTI_details_notification extends StatefulWidget {
  ...
  @override
  State<ASTI_details_notification> createState() =>
      _ASTI_details_notificationState();
}

class _ASTI_details_notificationState extends State<ASTI_details_notification> {
  String api = API_Names().api;
  Future<List<AstiDetailsModel>>? futurePost;
  String rejectNote = " ";

  Future<List<AstiDetailsModel>> fetchPostdetails() async {
    var response =
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<AstiDetailsModel>((json) => AstiDetailsModel.fromJson(json))
          .toList();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<AstiDetailsModel>>(
          future: futurePost,
