                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              _commonItemDescWidget('Damage Item', '${snapshot.data![index].xitem.toString()}, ${snapshot.data![index].productName.toString()}'),
                              _commonItemDescWidget('Damage Unit', '${snapshot.data![index].xunit.toString()}'),
                              _commonItemDescWidget('Damage Qty', '${snapshot.data![index].xdphqty.toString()}'),
                              _commonItemDescWidget('Converted Item', '${snapshot.data![index].xitemconv.toString()}, ${snapshot.data![index].convProductName.toString()}'),
                              _commonItemDescWidget('Converted Unit', snapshot.data![index].convUnit.toString()),
                              _commonItemDescWidget('Quantity', snapshot.data![index].xqtylead.toString()),
