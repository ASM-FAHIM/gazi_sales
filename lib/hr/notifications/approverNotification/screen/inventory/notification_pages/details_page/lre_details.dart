...
class LRE_details_notification extends StatefulWidget {
  ...
  @override
  State<LRE_details_notification> createState() =>
      _LRE_details_notificationState();
}

class _LRE_details_notificationState extends State<LRE_details_notification> {
  String api = API_Names().api;
  Future<List<LreDetailsModel>>? futurePost;
  String rejectNote = " ";
  ...
  Future<List<LreDetailsModel>> fetchPostdetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<LreDetailsModel>((json) => LreDetailsModel.fromJson(json))
          .toList();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<LreDetailsModel>>(
          future: futurePost,
