                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: ExpansionTile(
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${snapshot.data![index].sup ?? ""}(${snapshot.data![index].xcus ?? ""})",
                                      style: GoogleFonts.poppins(
                                        fontSize: 14,
                                        //color: Color(0xff074974),
                                      ),
                          ...
                          children: <Widget>[
                            ...
                            _commonExpansionTileWidget('Store', '${snapshot.data![index].xwh}, ${snapshot.data![index].xwhdesc}'),
                            _commonExpansionTileWidget('Challan No.', '${snapshot.data![index].xref}'),
                            _commonExpansionTileWidget('Challan Receive', '${snapshot.data![index].xnote1}'),
                            _commonExpansionTileWidget('Gate Entry No', '${snapshot.data![index].xgateentryno}'),
                            _commonExpansionTileWidget('Note', '${snapshot.data![index].xnote}'),
                            _commonExpansionTileWidget('GRN Status', '${snapshot.data![index].xstatusgrn}'),
                            //_commonExpansionTileWidget('Approval Status', '${snapshot.data![index].statusdocdesc}'),
                            const Divider(
                              thickness: 0.5,
                              color: Colors.grey,
                            ),
