...
import 'package:gazi_sales_app/hr/notifications/approverNotification/screen/sales_distribution/notification_pages/customer_approval_notification.dart';
import 'package:gazi_sales_app/hr/notifications/approverNotification/screen/sales_distribution/notification_pages/executive_change_notification.dart';
...
class _SalesDistributionState extends State<SalesDistribution> {
  ...
  String cusAppCount = "0";

  String exeChangeCount = "0";
  ...
  Future<String> getAdminNotificationCount() async {
    ...
    cusAppCount = salesCount1.cusCount.toString();
    exeChangeCount = salesCount1.excCount.toString();
