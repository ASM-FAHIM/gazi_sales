...
import '../hr/notifications/approverNotification/screen/hr_approver/notification_models/getPersonalNotificationCountModel.dart';
...
class _PersonalNotificationListState extends State<PersonalNotificationList> {
  ...
  late GetPersonalNotificationCount getPersonalNotificationCount;
  ...
  getAdminNotificationCount() async {
    ...
    var responseInv = await http.post(
        Uri.parse(
            'http://${AppConstants.baseurl}/gazi/HR/personalHR_Count.php'),
    ...
    getPersonalNotificationCount = getPersonalNotificationCountFromJson(responseInv.body);
    setState(() {
      pLateCount = getPersonalNotificationCount.lateCount.toString();
      pEarlyCount = getPersonalNotificationCount.earlyCount.toString();
      pAbsCount = getPersonalNotificationCount.absentCount.toString();
      pLeaveCount = getPersonalNotificationCount.leaveCount.toString();
    });
