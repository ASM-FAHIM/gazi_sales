...
import 'package:gazi_sales_app/hr/notifications/approverNotification/screen/finance_accounts/Notification_page/lc_costing_notification.dart';
...
class FinanceAccountNotificationList extends StatefulWidget {
  ...
  const FinanceAccountNotificationList({super.key,
...
class _FinanceAccountNotificationListState
  ...
  Future<String> getAdminNotificationCount() async {
    ...
    var responseInv = await http.get(Uri.parse(
        'http://${AppConstants
            .baseurl}/gazi/notification/accounts/total_accounts.php?zid=${widget
    ...
    lcCostingCount = accountsCount1.LCCount.toString();
